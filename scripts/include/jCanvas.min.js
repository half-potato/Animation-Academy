...
*/
(function(e,ta,ua,Ta,da,fa,na,v,x,h,p){function I(d){var c;if(P.future.inheritance)for(c in d)d.hasOwnProperty(c)&&(this[c]=d[c]);else $(this,d)}function P(d){var c;if(d)$(aa,d);else for(c in aa)aa.hasOwnProperty(c)&&delete aa[c];na&&na.warn&&!va.jCanvas&&(va.jCanvas=v);return this}function wa(){}function ka(d){return"string"===ba(d)}function L(d){return d&&d.getContext?d.getContext("2d"):h}function la(d){d=
